...
const getRaceData = (id: string): Race => ({
  id,
  name: 'V75 Solvalla',
  date: '2024-01-20',
  time: '15:00',
...
const getPlaceholderData = (id: string): Race => ({
  id,
  name: 'V75 Solvalla',
  date: '2024-01-20',
  time: '15:00',
...
const obfuscateData = (data: Race, selectedRaceIndex: number): Race => {
  const race = { ...data };
...
export default function RacePage() {
  ...
  const [displayData, setDisplayData] = useState<Race | null>(null);
  ...
  useEffect(() => {
    ...
    if (id) {
      const actualData = getRaceData(id as string);
      if (!token) {
                    ...
                    <Box sx={{ mt: 2, pt: 2, borderTop: '1px solid', borderColor: 'divider' }}>
                      <Grid container spacing={2}>
                        ...
                        <Grid item xs={12} md={4}>
                          ...
                          <Box sx={{ display: 'flex', flexDirection: 'column', gap: 0.5 }}>
                            {horse.horseInsights.map((insight: string, index: number) => (
                              <Box
                                key={index}
                                sx={{
                                  display: 'flex',
                        ...
                        <Grid item xs={12} md={4}>
                          ...
                          <Box sx={{ display: 'flex', flexDirection: 'column', gap: 0.5 }}>
                            {horse.driverInsights.map((insight: string, index: number) => (
                              <Box
                                key={index}
                                sx={{
                                  display: 'flex',
                  ...
                  <Box sx={{ mt: 2, pt: 2, borderTop: '1px solid', borderColor: 'divider' }}>
                    <Grid container spacing={2}>
                      ...
                      <Grid item xs={12} md={6}>
                        ...
                        <Box sx={{ display: 'flex', flexDirection: 'column', gap: 0.5 }}>
                          {currentRace.details.topPicks.longshot.horseInsights.map((insight: string, index: number) => (
                            <Box
                              key={index}
                              sx={{
                                display: 'flex',
                      ...
                      <Grid item xs={12} md={6}>
                        ...
                        <Box sx={{ display: 'flex', flexDirection: 'column', gap: 0.5 }}>
                          {currentRace.details.topPicks.longshot.driverInsights.map((insight: string, index: number) => (
                            <Box
                              key={index}
                              sx={{
                                display: 'flex',
